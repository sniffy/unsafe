 ...
 */
public class MethodHandleConstructorInvokerServiceProviderImpl implements ConstructorInvokerServiceProvider {


    @Override
    public <C> ConstructorInvoker<C> createConstructorInvoker(Class<C> clazz, Class<?>... parameterTypes) {
        try {
            /*
            ...
            @SuppressWarnings("BlockedPrivateApi") Field field = MethodHandles.Lookup.class.getDeclaredField("IMPL_LOOKUP");
            ...
            if (Java.versionWithFallback(8) > 8) {
