...
public class UnresolvedClassRef<C> extends UnresolvedRef<ClassRef<C>> {
    ...
    public @Nonnull <T> UnresolvedStaticFieldRef<C,T> tryGetStaticField(@Nonnull String fieldName) {
        try {
    ...
    @Nonnull
    public <T> UnresolvedStaticFieldRef<C,T> getStaticField(@Nonnull String fieldName) throws UnresolvedRefException {
    ...
    public @Nonnull <T> UnresolvedStaticFieldRef<C,T> tryFindFirstStaticField(@Nullable FieldFilter fieldFilter, boolean recursive) {
        try {
    ...
    public @Nonnull <T> UnresolvedStaticFieldRef<C,T> findFirstStaticField(@Nullable FieldFilter fieldFilter, boolean recursive) throws UnresolvedRefException {
        return resolve().findFirstStaticField(fieldFilter, recursive);
    }

    public @Nonnull Map<String, StaticFieldRef<C,Object>> findStaticFields(@Nullable FieldFilter fieldFilter, boolean recursive) throws UnresolvedRefException {
