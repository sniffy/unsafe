...
public class UnresolvedStaticObjectFieldRef<C,T> extends UnresolvedRef<ResolvedStaticObjectFieldRef<C,T>> implements UnresolvedFieldRef<C>, ObjectFieldRef<T> {
